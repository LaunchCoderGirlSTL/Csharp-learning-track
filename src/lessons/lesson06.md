...
* Watch and code along with [this lesson](https://mva.microsoft.com/en-US/training-courses/c-fundamentals-for-absolute-beginners-16169?l=ZSmQMdQIC_5106218949) about Working with Dates and Times from the C# for Absolute Beginners course
...
## Assignments
* Take the [Working with Strings Assessment](https://mva.microsoft.com/en-US/training-courses/c-fundamentals-for-absolute-beginners-16169?l=QFuG3iSIC_2106218949)
* Take the [Working with Dates and Times Assessment](https://mva.microsoft.com/en-US/training-courses/c-fundamentals-for-absolute-beginners-16169?l=B5P6fkSIC_8306218949)
...
* The first sentence of Alice in Wonderland is below. Store this sentence in a string, and then prompt the user for a string to search for within this string. Print whether the search term was found. See if you can make the search case-insensitive, so that searching for "alice" prints `true`. Upload your program to a new repository called CG 6-3
