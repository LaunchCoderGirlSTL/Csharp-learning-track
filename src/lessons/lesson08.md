...
## Prep Work
* Watch and code along with [this lesson](https://mva.microsoft.com/en-US/training-courses/c-fundamentals-for-absolute-beginners-16169?l=kCLKbyQIC_9106218949) about Understanding Scope and Accessibility Modifiers from the C# for Absolute Beginners course
...
* [This article](https://msdn.microsoft.com/en-us/magazine/mt694084.aspx) should help clarify what .NET Core is today and what its goals are, how it relates to the Microsoft .NET Framework and the fundamentals of the command-line tooling that you can use to get started with .NET Core
...
* Read all 13 parts of [this Classes tutorial](http://csharp.net-tutorials.com/classes/introduction/) and review what you have already learned and extend your knowledge with inheritance, abstraction and interfaces
...
## Assignments
* Take the [Understanding Scope and Accessibility Modifiers Assessment](https://mva.microsoft.com/en-US/training-courses/c-fundamentals-for-absolute-beginners-16169?l=LK8n0uQIC_306218949)
* Take the [Understanding Namespaces and Working with the .NET Class Library Assessment](https://mva.microsoft.com/en-US/training-courses/c-fundamentals-for-absolute-beginners-16169?l=JUpuxzQIC_5506218949)
