...
* Watch and code along with [this lesson](https://mva.microsoft.com/en-US/training-courses/windows-10-development-for-absolute-beginners-14541?l=HnWxaNzqB_7805632527) from the Windows 10 Development for Absolute Beginners course to create a cheat sheet for yourself
* Complete [this multi-part tutorial](https://docs.microsoft.com/en-us/windows/uwp/design/basics/xaml-basics-ui) to work with a more polished sample application.
* Read [this article](https://docs.microsoft.com/en-us/windows/uwp/design/controls-and-patterns/forms) on laying out forms.  You will probably spend a lot of time creating forms throughout your career.
* Read [this article](https://docs.microsoft.com/en-us/windows/uwp/launch-resume/app-lifecycle) that explains what a Universal Windows application when you close it or minimize it.
...
* Understand how UWP applications handle memory while they are running

## Assignments
* Take the [XAML Layout with Grids Assessment](https://mva.microsoft.com/en-US/training-courses/windows-10-development-for-absolute-beginners-14541?l=5ljHqFzqB_5105632527)
* Take the [XAML Layout with StackPanel Assessment](https://mva.microsoft.com/en-US/training-courses/windows-10-development-for-absolute-beginners-14541?l=lba4LJzqB_1105632527)
* Take the [Cheat Sheet Review: XAML and Layout Controls Assessment](https://mva.microsoft.com/en-US/training-courses/windows-10-development-for-absolute-beginners-14541?l=HnWxaNzqB_7805632527)
...
* Take the [Laudable Layout Challenge: Solution Assessment](https://mva.microsoft.com/en-US/training-courses/windows-10-development-for-absolute-beginners-14541?l=0drdpTzqB_805632527)
...
* Take the [Legendary Layout Challenge: Solution Assessment](https://mva.microsoft.com/en-US/training-courses/windows-10-development-for-absolute-beginners-14541?l=cXkrdZzqB_2605632527)
...
* Take the [Laborious Layout Challenge: Solution Assessment](https://mva.microsoft.com/en-US/training-courses/windows-10-development-for-absolute-beginners-14541?l=2C4AIfzqB_9005632527)

## Resources
* [Rapid XAML Toolkit](https://github.com/Microsoft/Rapid-XAML-Toolkit) -  Build your user interface for you based on your classes.
* [Application Lifecyle](https://mva.microsoft.com/en-US/training-courses/a-developers-guide-to-windows-10-12618?l=nXtix0pRB_5205095281) – A 1-hour video that goes more in depth on application lifecycle.
