...
* Watch and code along with [this lesson](https://mva.microsoft.com/en-US/training-courses/c-fundamentals-for-absolute-beginners-16169?l=vE6GqMQIC_506218949) about Working with Code Files, Projects, and Solutions from the C# For Absolute Beginners course
* Watch and code along with [this lesson](https://mva.microsoft.com/en-US/training-courses/c-fundamentals-for-absolute-beginners-16169?l=Y6D7PQQIC_5406218949) about Understanding Data Types and Variables from the C# For Absolute Beginners course
...
## Assignments
* Take the [Working with Code Files, Projects, and Solutions Assessment](https://mva.microsoft.com/en-US/training-courses/c-fundamentals-for-absolute-beginners-16169?l=Kcqx4iIPC_1705244527)
* Take the [Understanding Data Types and Variables Assessment](https://mva.microsoft.com/en-US/training-courses/c-fundamentals-for-absolute-beginners-16169?l=vq8jiCSIC_3706218949)
...
* **GitHub for Beginners:** The tutorial is using a Mac. And windows users don't have the touch command (or might not). You can use this instead: copy nul > readme.txt
* **GitHub for Beginners:** git push seems to not have all the information you need the first time you push. Try this instead: git push -u origin master If you have already done the tutorial and have done git push and gotten the warning with the suggestion and did the suggestion, then you did the right thing.
